...
-- Crear tabla BRONCE de Reservas del Hotel
...
-- Cargando Data desde Stage to Bronze Table
...
-- Crear tabla SILVER_HOTEL_BOOKINGS
...
-- Inserción de datos depurados en la capa Silver
